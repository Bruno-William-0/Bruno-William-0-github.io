...
var getLastPart = function getLastPart2(functionName) {
  var parts7 = functionName.split(".");
  return parts7[parts7.length - 1];
};
...
var createEmotionProps = function createEmotionProps2(type, props5) {
  if (typeof props5.css === "string" && // check if there is a css declaration
  props5.css.indexOf(":") !== -1) {
    throw new Error("Strings are not allowed as css prop values, please wrap it in a css template literal from '@emotion/react' like this: css`" + props5.css + "`");
  }
  var newProps = {};
  for (var _key in props5) {
    if (hasOwn.call(props5, _key)) {
      newProps[_key] = props5[_key];
    }
  }
  newProps[typePropName] = type;
  if (typeof globalThis !== "undefined" && !!globalThis.EMOTION_RUNTIME_AUTO_LABEL && !!props5.css && (typeof props5.css !== "object" || !("name" in props5.css) || typeof props5.css.name !== "string" || props5.css.name.indexOf("-") === -1)) {
...
var Emotion = withEmotionCache(function(props5, cache2, ref2) {
  ...
  var newProps = {};
  for (var _key2 in props5) {
    if (hasOwn.call(props5, _key2) && _key2 !== "css" && _key2 !== typePropName && _key2 !== labelPropName) {
      newProps[_key2] = props5[_key2];
    }
  }
...
var jsx = function jsx2(type, props5) {
  var args = arguments;
  if (props5 == null || !hasOwn.call(props5, "css")) {
    return React3.createElement.apply(void 0, args);
  }
  var argsLength = args.length;
  var createElementArgArray = new Array(argsLength);
  createElementArgArray[0] = Emotion$1;
  createElementArgArray[1] = createEmotionProps(type, props5);
...
var Global = withEmotionCache(function(props5, cache2) {
  ...
  ("className" in props5 && props5.className || "css" in props5 && props5.css)) {
...
var Insertion5 = ({ cache: cache2, serialized, isStringTag }) => {
  registerStyles3(cache2, serialized, isStringTag);
  const rules = useInsertionEffectAlwaysWithSyncFallback2(
...
var createStyled = (tag, configOrCva = {}, options = {}) => {
  ...
  const Styled = withEmotionCache((inProps, cache2, ref2) => {
    ...
    if (props5.asChild && !forwardAsChild) {
      const child = React5.Children.only(props5.children);
      FinalTag = child.type;
...
var SliderDraggingIndicator = withContext46(slider_exports.DraggingIndicator, "draggingIndicator", { forwardAsChild: true });
